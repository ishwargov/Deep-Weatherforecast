...
grid_pad = np.pad(grid,((15,15),(15,15),(0,0),(0,0)),mode='constant',constant_values=((0,0),(0,0),(0,0),(0,0)))
...
dat = blocks[latlon_to_block[(30,40)]]
...
def make_data(blocks,grid_pad,block_num,horizon):
  ...
  for i in range(block.shape[3]-horizon):
    x.append(np.rollaxis(grid[(p-9):(p+19),(q-9):(q+19),:,i:i+12],3,0))
    y.append(block[:,:,:,i+12])
...
x,y = make_data(blocks,grid_pad,latlon_to_block[(30,40)],12)
